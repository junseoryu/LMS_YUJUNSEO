 ...
 function endDateCheck(){
  ...
  function addCategory() {
	...
	if(count == 1){
	 ...
	 div.innerHTML += "<div id='Category"+count+"' >";
	 div.innerHTML += "<select  name='category' onChange='addName(this.options[this.selectedIndex].value,"+count+")' style = 'float: left; width: 10%; margin-right: 5%'>" + "<option value='T'>과제</option>" + "<option value='Q'>퀴즈</option>" + "<option value='A'>출결</option>"+ "<option value='E'>기타</option>"+ "</select>";
	 div.innerHTML += "<input type='text'  placeholder='백분율 입력(%)' style = 'float: left; width: 30%; margin-left: -3%; ' name='addGrade' value=''  />";
	 div.innerHTML += "<div id='addName"+count+"' style = 'margin-right:20%;'></div>";
	 div.innerHTML += "<div class='delButton'><input type='button' value='삭제' onClick='deleteCategory("+count+")' ></div></div>";
	}else{
	 for(i=0; i < count-1; i++){
	...
	index = 0;
	div.innerHTML = save +"<div id='Category"+count+"'><br>";
	 div.innerHTML += "<br><select  name='category' onChange='addName(this.options[this.selectedIndex].value,"+count+")' style = 'float: left; width: 10%; margin-right: 5%'>" + "<option value='T'>과제</option>" + "<option value='Q'>퀴즈</option>" + "<option value='A'>출결</option>"+ "<option value='E'>기타</option>"+ "</select>";
	 div.innerHTML += "<input type='text'  placeholder='백분율 입력(%)' style = 'float: left; width: 30%; margin-left: -3%;' name='addGrade' value=''  />";
	 div.innerHTML += "<div id='addName"+count+"' style = 'margin-right:20%;'></div>";
	 div.innerHTML += "<div class='delButton'><input type='button' value='삭제' onClick='deleteCategory("+count+")' </div></div>";
