...
function allMemberListView(jsonData){
	...
	for(i=0; i<jsonData.length; i++){
		...
		if(jsonData[i].mbType == "T" && jsonData[i].status =="W"){
			...
			if(jsonData[i].status == "G"){
				stuList.innerHTML += "<input type = 'hidden' name = 'mbId' value = '"+jsonData[i].mbId+"' ><div style ='margin-left:25%;'><div class = 'mbId2'>"+jsonData[i].mbId+"</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class = 'mbName2'>"+jsonData[i].mbName+"</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span name='confirm' style = 'float: left; width: 10%;'>활동 중</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class = 'auth2'><input type = 'button' name = 'stop' value='"+"정지"+"' onClick='stuPermission(this.value, "+i+")' /></div></div><br><br>";
			}else{
				stuList.innerHTML += "<input type = 'hidden' name = 'mbId' value = '"+jsonData[i].mbId+"' ><div style ='margin-left:25%;'><div class = 'mbId2'>"+jsonData[i].mbId+"</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class = 'mbName2'>"+jsonData[i].mbName+"</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span name='confirm' style = 'float: left; width: 10%; color: red; font-weight:bold;'>정지</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class = 'auth2'><input type = 'button' name = 'stop' value='"+"활동"+"' onClick='stuPermission(this.value, "+i+")' /></div></div><br><br>";
			}
